...
Ctrl::Ctrl()
{
    ...
    position_sub=nh.subscribe("/iris_0/mavros/local_position/odom", 10, &Ctrl::position_cb, this);
    ...
    local_pos_pub = nh.advertise<mavros_msgs::PositionTarget>("/cmd_sub_test", 1);
...
{
	ros::init(argc, argv, "fuel_ctrl_v1");
	setlocale(LC_ALL,"");
    Ctrl ctrl;
    ros::spin();
	return 0;
